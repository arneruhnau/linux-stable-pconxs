...
#endif
{
	...
	if (!pool)
		return -ENOMEM;
// who is dodane patryk? anyway, DMA allocation does not work, but this does:
        res = platform_get_resource_byname(pdev, IORESOURCE_MEM, "contiguous-addr"); //dodane patryk
	if (res) {
